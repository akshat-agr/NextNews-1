  ...
  return (
    <div className="text-center py-30 px-4">
      ...
      <div className="mt-20 space-x-4">
        <Link to="/demo">
          <button className="cursor-pointer px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-700 text-white hover:from-blue-700 hover:to-blue-500 rounded-xl font-semibold transition-all duration-300">
            Try Demo!
          </button>
        </Link>
